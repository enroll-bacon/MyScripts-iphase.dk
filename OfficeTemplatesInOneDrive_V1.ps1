...
# Put your Sharepoint ODOPEN URL here. Remove the &userEmail=xxx@xxxx.xxx and userID=xxxxx part of the string
$ODurl = 'odopen://sync?'
...
$SyncPath = "$($env:USERPROFILE)\SYNC FOLDER"
...
$OfficeVersionCode = "SET OFFICE Version" 
...
# Word
New-Item -Path "HKCU:\Software\Microsoft\Office\$OfficeVersionCode\Word" -Name "Options" -Confirm:$false -ErrorAction SilentlyContinue
...
# Excel
New-Item -Path "HKCU:\Software\Microsoft\Office\$OfficeVersionCode\Excel" -Name "Options" -Confirm:$false -ErrorAction SilentlyContinue
...
# PowerPoint
New-Item -Path "HKCU:\Software\Microsoft\Office\$OfficeVersionCode\PowerPoint" -Name "Options" -Confirm:$false -ErrorAction SilentlyContinue
